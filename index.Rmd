...
* Code
    * Motivation
        ...
        * A deep learning ["hello world" example](https://tensorflow.rstudio.com/tutorials/beginners/): recognizing handwritten digits from the [MNIST](https://en.wikipedia.org/wiki/MNIST_database) dataset. 
